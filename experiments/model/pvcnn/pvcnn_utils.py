...
from .modules import SharedMLP, PVConv, PointNetSAModule, PointNetAModule, PointNetFPModule, Swish
...
def create_pointnet2_sa_components(sa_blocks, extra_feature_channels, use_att=False,
    ...
    for conv_configs, sa_configs in sa_blocks:
        ...
        sa_blocks.append(
            block(in_channels=extra_feature_channels, out_channels=out_channels,
